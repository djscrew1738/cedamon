        ...
        <div className={styles.sectionContent}>
          ...
          <div className={styles.toolPhaseGrid}>
            ...
            {[
              ...
              { id: 'execute_masscan', label: 'execute_masscan' },
              ...
              { id: 'execute_searchsploit', label: 'execute_searchsploit' },
